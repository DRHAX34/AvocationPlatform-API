...
{
    public class ClientManager : ConfigBase
    {
        public IEnumerable<ClientModel> GetClients(Guid? pClientId = null,
            Guid? pRecruiterId = null, Guid? pRoomId = null, Guid? pOpeningId = null, Guid? pCandidateId = null, bool WithDeleted = false)
        {
            ...
            var rs = SqlHelper.QuerySP<ClientModel>("spGetClients", parameters, null, null, false, 0, Connection.ConnectionString);
        ...
        public ClientModel InsertUpdateClient(ClientModel rq, string Username)
        {
            var parameters = new DynamicParameters();
            parameters.Add("@ClientId", rq.Id, DbType.Guid);
            parameters.Add("@Name", rq.Name, DbType.String);
            parameters.Add("@VAT", rq.VAT, DbType.String);
            parameters.Add("@PictureUri", rq.PictureUri, DbType.String);
            ...
            var rs = SqlHelper.ExecuteScalar("spInsertUpdateClient", parameters, null, null, 0, Connection.ConnectionString);
        ...
        public bool DeleteClient(Guid? pClientId, string pUsername)
        {
            var parameters = new DynamicParameters();
            parameters.Add("@ClientId", pClientId, DbType.Guid);
            parameters.Add("@Username", pUsername, DbType.String);

            var rs = SqlHelper.ExecuteSP("spDeleteClient", parameters, null, null, 0, Connection.ConnectionString);
